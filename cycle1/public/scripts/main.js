...
var author$project$Wallet$decoder = A2(
	...
	function (str) {
		switch (str) {
			case '':
				return elm$json$Json$Decode$fail('Wallet not supported');
			case 'webext':
				return elm$json$Json$Decode$succeed(author$project$Wallet$WebExt);
			default:
				return elm$json$Json$Decode$fail('Format not supported');
		}
	},
	elm$json$Json$Decode$string);
...
var author$project$Main$flagDecoder = A3(
	...
	A2(
		elm$json$Json$Decode$field,
		'wallet',
		elm$json$Json$Decode$nullable(author$project$Wallet$decoder)));
...
var author$project$Main$registerUrl = F2(
	function (maybeWallet, maybeKeyPair) {
		var _n0 = _Utils_Tuple2(maybeWallet, maybeKeyPair);
		if (_n0.a.$ === 'Just') {
			if (_n0.b.$ === 'Nothing') {
				var _n3 = _n0.b;
...
var author$project$Main$guardUrl = F4(
	function (navKey, maybeRoute, maybeWallet, maybeKeyPair) {
		if ((maybeRoute.$ === 'Just') && (maybeRoute.a.$ === 'Register')) {
			var url = A2(author$project$Main$registerUrl, maybeWallet, maybeKeyPair);
			return A2(elm$browser$Browser$Navigation$pushUrl, navKey, url);
		} else {
...
var author$project$Route$queryOverlay = A2(
...
var author$project$Main$init = F3(
	function (flags, url, navKey) {
		...
		var _n0 = A2(
			...
			{maybeKeyPair: elm$core$Maybe$Nothing, maybeWallet: elm$core$Maybe$Nothing},
			A2(elm$json$Json$Decode$decodeValue, author$project$Main$flagDecoder, flags));
		var maybeKeyPair = _n0.maybeKeyPair;
		var maybeWallet = _n0.maybeWallet;
		var cmd = A4(author$project$Main$guardUrl, navKey, maybeRoute, maybeWallet, maybeKeyPair);
		return _Utils_Tuple2(
			{keyPair: maybeKeyPair, navKey: navKey, overlay: maybeOverlay, page: page, topBarModel: author$project$TopBar$init, url: url, wallet: maybeWallet},
			cmd);
	});
...
var author$project$Main$cmdFromOverlay = function (maybeOverlay) {
	if ((maybeOverlay.$ === 'Just') && (maybeOverlay.a.$ === 'WaitForKeyPair')) {
		var _n1 = maybeOverlay.a;
		return author$project$Main$requireKeyPair(_Utils_Tuple0);
	} else {
		return elm$core$Platform$Cmd$none;
	}
};
var author$project$Main$registerProject = _Platform_outgoingPort('registerProject', elm$core$Basics$identity);
				...
				if (_n5.$ === 'Register') {
					...
					var portCmd = function () {
						if (subCmd.$ === 'Register') {
							...
							return author$project$Main$registerProject(
								author$project$Project$encode(project));
						} else {
							return elm$core$Platform$Cmd$none;
						}
					}();
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							wallet: elm$core$Maybe$Just(author$project$Wallet$WebExt)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							A2(author$project$Style$Color$alpha, author$project$Style$Color$blue, 0.1)),
							mdgriffith$elm_ui$Element$padding(24),
							mdgriffith$elm_ui$Element$Border$color(author$project$Style$Color$purple),
							mdgriffith$elm_ui$Element$Border$rounded(2),
					...
					_List_fromArray(
						[
							A2(
							mdgriffith$elm_ui$Element$el,
							author$project$Style$Font$mediumBodyText(author$project$Style$Color$purple),
							mdgriffith$elm_ui$Element$text(contract)),
							A2(
							mdgriffith$elm_ui$Element$paragraph,
							_Utils_ap(
								_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$text('Some more text about this all, explaining what it’s about and how it should be interpreted. I mean I’m just writing sentences to have enough copy.')
								])),
							A2(
							mdgriffith$elm_ui$Element$el,
							author$project$Style$Font$linkText(author$project$Style$Color$purple),
...
var author$project$Page$Project$Header$viewLogo = A2(
	...
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Background$color(author$project$Style$Color$radicleBlue),
			mdgriffith$elm_ui$Element$height(
	...
	A2(
		...
		_List_fromArray(
			[mdgriffith$elm_ui$Element$centerX, mdgriffith$elm_ui$Element$centerY]),
		mdgriffith$elm_ui$Element$text('rad')));
...
var author$project$Page$Project$Header$viewMeta = A2(
	mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$spacing(8),
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$text('Radicle')),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_Utils_ap(
				_List_fromArray(
...
var author$project$Page$Project$Header$viewStats = A2(
	...
	_List_fromArray(
		[
			A3(author$project$Page$Project$Header$statsColumn, '1043', 'dependents', '192 immediate'),
			A3(author$project$Page$Project$Header$statsColumn, '0.84', 'osrank', '85th percentile')
		]));
var author$project$Page$Project$Header$view = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$spacing(24),
			mdgriffith$elm_ui$Element$height(
			mdgriffith$elm_ui$Element$px(112)),
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
		]),
	_List_fromArray(
		[author$project$Page$Project$Header$viewLogo, author$project$Page$Project$Header$viewMeta, author$project$Page$Project$Header$viewStats]));
...
var author$project$Page$Project$People$viewTopPeopleSingle = function (name) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				{description: 'avatar', src: 'https://res.cloudinary.com/juliendonck/image/upload/v1536080565/avatars/6163.png'}),
				A2(
				mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
...
var author$project$Page$Project$People$viewTopPeople = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Page$Project$People$viewTopPeopleSingle('Jane Doe'),
							author$project$Page$Project$People$viewTopPeopleSingle('Jimmy Bong'),
							author$project$Page$Project$People$viewTopPeopleSingle('Lorie Mike'),
							author$project$Page$Project$People$viewTopPeopleSingle('Harrold Downy')
						])),
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_fromArray(
...
var author$project$Page$Project$People$view = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$spacing(24),
...
var author$project$Page$Register$SetDonationRule = function (a) {
	return {$: 'SetDonationRule', a: a};
};
var author$project$Page$Register$SetRewardRule = function (a) {
	return {$: 'SetRewardRule', a: a};
};
var author$project$Page$Register$SetRoleRule = function (a) {
...
var author$project$Page$Register$viewContract = function (contract) {
	var viewRoleOption = F2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						author$project$Page$Register$SetRoleRule(role))
					]),
				button(
					author$project$Project$Contract$roleString(role)));
		});
	var viewRewardOption = F2(
		function (current, reward) {
			...
			return A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Events$onClick(
						author$project$Page$Register$SetRewardRule(reward))
					]),
				button(
					author$project$Project$Contract$rewardString(reward)));
		});
	var viewDonationOption = F2(
		function (current, donation) {
			...
			return A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Events$onClick(
						author$project$Page$Register$SetDonationRule(donation))
					]),
				button(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					viewRewardOption(currentReward),
					rewards)),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_Nil,
				A2(
					elm$core$List$map,
					viewDonationOption(currentDonation),
					donations)),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_Nil,
...
var author$project$Page$Register$UpdateDescription = function (a) {
	return {$: 'UpdateDescription', a: a};
};
var author$project$Page$Register$UpdateImageUrl = function (a) {
	return {$: 'UpdateImageUrl', a: a};
};
var author$project$Page$Register$UpdateName = function (a) {
...
var author$project$Page$Register$view = function (_n0) {
	...
	var viewStep = function () {
		switch (step.$) {
			...
			case 'Contract':
				return author$project$Page$Register$viewContract(
...
var author$project$Wallet$toString = function (wallet) {
	return 'web extension';
};
var author$project$Main$viewWallet = function (maybeWallet) {
	if (maybeWallet.$ === 'Just') {
		var wallet = maybeWallet.a;
		return A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[mdgriffith$elm_ui$Element$centerX, mdgriffith$elm_ui$Element$centerY]),
					mdgriffith$elm_ui$Element$text(
						'Wallet connected: ' + author$project$Wallet$toString(wallet)))
				]));
	} else {
		return mdgriffith$elm_ui$Element$none;
	}
...
var author$project$Main$view = function (model) {
	var rUrl = A2(author$project$Main$registerUrl, model.wallet, model.keyPair);
	...
	return {
				...
				A2(
					...
					_List_fromArray(
						[
							...
							A2(author$project$TopBar$view, model.topBarModel, rUrl)),
		...
		title: A2(elm$core$String$join, ' <> ', titleParts)
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Main$init, onUrlChange: author$project$Main$UrlChanged, onUrlRequest: author$project$Main$LinkClicked, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Project.Meta":{"args":[],"type":"{ codeHostUrl : String.String, description : String.String, imageUrl : String.String, name : String.String, websiteUrl : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"OverlayWalletSetup":["Overlay.WalletSetup.Msg"],"PageRegister":["Page.Register.Msg"],"TopBarMsg":["TopBar.Msg"],"KeyPairCreated":["Maybe.Maybe KeyPair.KeyPair"],"KeyPairFetched":["Maybe.Maybe KeyPair.KeyPair"],"WalletWebExtPresent":["()"]}},"KeyPair.KeyPair":{"args":[],"tags":{"KeyPair":["String.String"]}},"Overlay.WalletSetup.Msg":{"args":[],"tags":{"MoveToPick":[]}},"Page.Register.Msg":{"args":[],"tags":{"BlurCodeHost":[],"BlurName":[],"MoveStepContract":[],"MoveStepPreview":[],"Register":["Project.Project"],"SetDonationRule":["Project.Contract.Donation"],"SetRewardRule":["Project.Contract.Reward"],"SetRoleRule":["Project.Contract.Role"],"UpdateCodeHostUrl":["String.String"],"UpdateDescription":["String.String"],"UpdateImageUrl":["String.String"],"UpdateName":["String.String"],"UpdateWebsiteUrl":["String.String"]}},"TopBar.Msg":{"args":[],"tags":{"SearchUpdated":["String.String"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Project.Project":{"args":[],"tags":{"Project":["Project.Meta","Project.Contract.Contract"]}},"Project.Contract.Donation":{"args":[],"tags":{"DonationFundSaving":[],"DonationEqualMaintainer":[],"DonationEqualDependency":[],"DonationCustom":["Basics.Int","Basics.Int","Basics.Int","Basics.Int"]}},"Project.Contract.Reward":{"args":[],"tags":{"RewardBurn":[],"RewardFundSaving":[],"RewardEqualMainatainer":[],"RewardEqualDependency":[],"RewardCustom":["Basics.Int","Basics.Int","Basics.Int","Basics.Int"]}},"Project.Contract.Role":{"args":[],"tags":{"RoleMaintainerSingleSigner":[],"RoleMaintainerMultiSig":[]}},"Project.Contract.Contract":{"args":[],"tags":{"Contract":["Project.Contract.Reward","Project.Contract.Donation","Project.Contract.Role"]}}}}})}});}(this));