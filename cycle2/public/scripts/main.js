...
var author$project$Main$Flags = F2(
	function (maybeKeyPair, projects) {
		return {maybeKeyPair: maybeKeyPair, projects: projects};
	});
...
var author$project$Project$Address$Address = function (a) {
	return {$: 'Address', a: a};
};
...
var author$project$Project$Address$decoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		if (str === '') {
			return elm$json$Json$Decode$fail('unknown address format');
		} else {
			return elm$json$Json$Decode$succeed(
				author$project$Project$Address$Address(str));
		}
	},
...
var author$project$Project$Contract$RewardEqualMaintainer = {$: 'RewardEqualMaintainer'};
...
var author$project$Project$Contract$rewardFromString = function (currentReward) {
	switch (currentReward) {
		...
		case 'EqualMaintainer':
			return elm$core$Maybe$Just(author$project$Project$Contract$RewardEqualMaintainer);
		case 'EqualDependency':
...
var author$project$Project$Contract$decoder = A4(
	...
	A2(elm$json$Json$Decode$field, 'reward', author$project$Project$Contract$decodeReward),
	A2(elm$json$Json$Decode$field, 'donation', author$project$Project$Contract$decodeDonation),
	A2(elm$json$Json$Decode$field, 'role', author$project$Project$Contract$decodeRole));
var author$project$Project$Funds$Funds = F2(
	function (a, b) {
		return {$: 'Funds', a: a, b: b};
	});
...
var author$project$Project$Funds$Exchange = F6(
	function (date, destinations, incoming, outgoing, rule, source) {
		return {date: date, destinations: destinations, incoming: incoming, outgoing: outgoing, rule: rule, source: source};
	});
var author$project$Project$Contract$defaultDonation = author$project$Project$Contract$DonationFundSaving;
var author$project$Project$Contract$defaultReward = author$project$Project$Contract$RewardBurn;
var author$project$Project$Funds$DonationRule = function (a) {
	return {$: 'DonationRule', a: a};
};
var author$project$Project$Funds$Outgoing = {$: 'Outgoing'};
var author$project$Project$Funds$RewardRule = function (a) {
	return {$: 'RewardRule', a: a};
};
var author$project$Project$Funds$TransferRule = function (a) {
	return {$: 'TransferRule', a: a};
};
var author$project$Project$Funds$donationRuleDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Project$Funds$DonationRule,
	A2(elm$json$Json$Decode$field, 'rule', author$project$Project$Contract$decodeDonation));
var author$project$Project$Funds$exchangeRuleType = function (rule) {
	switch (rule.$) {
		case 'DonationRule':
			return 'donation';
		case 'RewardRule':
...
var author$project$Project$Funds$is = function (expected) {
	return function (val) {
		return _Utils_eq(val, expected);
	};
};
var author$project$Project$Funds$rewardRuleDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Project$Funds$RewardRule,
	A2(elm$json$Json$Decode$field, 'rule', author$project$Project$Contract$decodeReward));
var author$project$Project$Funds$transferDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		if (str === 'outgoing') {
			return elm$json$Json$Decode$succeed(author$project$Project$Funds$Outgoing);
		} else {
			return elm$json$Json$Decode$fail('unknown transfer');
		}
	},
	elm$json$Json$Decode$string);
var author$project$Project$Funds$transferRuleDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Project$Funds$TransferRule,
	A2(elm$json$Json$Decode$field, 'rule', author$project$Project$Funds$transferDecoder));
...
var author$project$Project$Funds$ruleDecoder = function () {
	...
	return elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				typeDecoder,
				author$project$Project$Funds$is(
					author$project$Project$Funds$exchangeRuleType(
						author$project$Project$Funds$DonationRule(author$project$Project$Contract$defaultDonation))),
				author$project$Project$Funds$donationRuleDecoder),
				A3(
				elm_community$json_extra$Json$Decode$Extra$when,
				typeDecoder,
				author$project$Project$Funds$is(
					author$project$Project$Funds$exchangeRuleType(
						author$project$Project$Funds$RewardRule(author$project$Project$Contract$defaultReward))),
				author$project$Project$Funds$rewardRuleDecoder),
				A3(
				elm_community$json_extra$Json$Decode$Extra$when,
				typeDecoder,
				author$project$Project$Funds$is(
					author$project$Project$Funds$exchangeRuleType(
						author$project$Project$Funds$TransferRule(author$project$Project$Funds$Outgoing))),
				author$project$Project$Funds$transferRuleDecoder)
			]));
}();
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$map6 = _Json_map6;
var author$project$Project$Funds$exchangeDecoder = A7(
	elm$json$Json$Decode$map6,
	author$project$Project$Funds$Exchange,
	A2(elm$json$Json$Decode$field, 'date', elm$json$Json$Decode$string),
	A2(
		elm$json$Json$Decode$field,
		'destinations',
		elm$json$Json$Decode$list(elm$json$Json$Decode$string)),
	A2(elm$json$Json$Decode$field, 'incoming', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'outgoing', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'rule', author$project$Project$Funds$ruleDecoder),
	A2(elm$json$Json$Decode$field, 'source', elm$json$Json$Decode$string));
var author$project$Project$Funds$decoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Project$Funds$Funds,
	A2(elm$json$Json$Decode$field, 'oscoin', author$project$Project$Funds$coinsDecoder),
	A2(
		elm$json$Json$Decode$field,
		'exchanges',
		elm$json$Json$Decode$list(author$project$Project$Funds$exchangeDecoder)));
var author$project$Project$Graph$Graph = F3(
	function (a, b, c) {
		return {$: 'Graph', a: a, b: b, c: c};
	});
var author$project$Project$Graph$Percentile = function (a) {
	return {$: 'Percentile', a: a};
};
var author$project$Project$Graph$Rank = function (a) {
	return {$: 'Rank', a: a};
};
var author$project$Project$Graph$Edge = F3(
	function (a, b, c) {
		return {$: 'Edge', a: a, b: b, c: c};
	});
var author$project$Project$Graph$Incoming = {$: 'Incoming'};
var author$project$Project$Graph$Outgoing = {$: 'Outgoing'};
var author$project$Project$Graph$directionDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'incoming':
				return elm$json$Json$Decode$succeed(author$project$Project$Graph$Incoming);
			case 'outgoing':
				return elm$json$Json$Decode$succeed(author$project$Project$Graph$Outgoing);
			default:
				return elm$json$Json$Decode$fail('unknown direction');
		}
	},
	elm$json$Json$Decode$string);
var elm$json$Json$Decode$float = _Json_decodeFloat;
var author$project$Project$Graph$edgeDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Project$Graph$Edge,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'direction', author$project$Project$Graph$directionDecoder),
	A2(
		elm$json$Json$Decode$field,
		'osrank',
		A2(elm$json$Json$Decode$map, author$project$Project$Graph$Rank, elm$json$Json$Decode$float)));
var author$project$Project$Graph$decoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Project$Graph$Graph,
	A2(
		elm$json$Json$Decode$field,
		'osrank',
		A2(elm$json$Json$Decode$map, author$project$Project$Graph$Rank, elm$json$Json$Decode$float)),
	A2(
		elm$json$Json$Decode$field,
		'percentile',
		A2(elm$json$Json$Decode$map, author$project$Project$Graph$Percentile, elm$json$Json$Decode$int)),
	A2(
		elm$json$Json$Decode$field,
		'edges',
		elm$json$Json$Decode$list(author$project$Project$Graph$edgeDecoder)));
var author$project$Project$Meta$Meta = F5(
	function (codeHostUrl, description, imageUrl, name, websiteUrl) {
		return {codeHostUrl: codeHostUrl, description: description, imageUrl: imageUrl, name: name, websiteUrl: websiteUrl};
	});
var elm$json$Json$Decode$map5 = _Json_map5;
var author$project$Project$Meta$decoder = A6(
	elm$json$Json$Decode$map5,
	author$project$Project$Meta$Meta,
	A2(elm$json$Json$Decode$field, 'codeHostUrl', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'description', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'imageUrl', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'websiteUrl', elm$json$Json$Decode$string));
var elm$json$Json$Decode$map8 = _Json_map8;
var author$project$Project$dataDecoder = A9(
	elm$json$Json$Decode$map8,
	author$project$Project$Data,
	A2(elm$json$Json$Decode$field, 'address', author$project$Project$Address$decoder),
	A2(elm$json$Json$Decode$field, 'contract', author$project$Project$Contract$decoder),
	A2(elm$json$Json$Decode$field, 'funds', author$project$Project$Funds$decoder),
	A2(elm$json$Json$Decode$field, 'graph', author$project$Project$Graph$decoder),
	A2(elm$json$Json$Decode$field, 'meta', author$project$Project$Meta$decoder),
	A2(
		elm$json$Json$Decode$field,
		'contributors',
		elm$json$Json$Decode$list(author$project$Person$decoder)),
	A2(
		elm$json$Json$Decode$field,
		'maintainers',
		elm$json$Json$Decode$list(author$project$Person$decoder)),
	A2(
		...
		'checkpoints',
		elm$json$Json$Decode$list(elm$json$Json$Decode$string)));
var author$project$Project$decoder = A2(elm$json$Json$Decode$map, author$project$Project$Project, author$project$Project$dataDecoder);
...
var author$project$Main$flagDecoder = A3(
	...
	A2(
		elm$json$Json$Decode$field,
		'projects',
		elm$json$Json$Decode$list(author$project$Project$decoder)));
var elm$core$Debug$log = _Debug_log;
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Main$decodeFlags = function (encodedFlags) {
	var _n0 = A2(elm$json$Json$Decode$decodeValue, author$project$Main$flagDecoder, encodedFlags);
	if (_n0.$ === 'Ok') {
		var decodedFlags = _n0.a;
		return decodedFlags;
	} else {
		var err = _n0.a;
		var _n1 = A2(elm$core$Debug$log, 'Main.Flags.decode', err);
		return A2(author$project$Main$Flags, elm$core$Maybe$Nothing, _List_Nil);
	}
};
...
var author$project$Page$Project$Model = F4(
	function (a, b, c, d) {
		return {$: 'Model', a: a, b: b, c: c, d: d};
	});
var author$project$Page$Project$init = F2(
	function (project, maybeKeyPair) {
		return A4(author$project$Page$Project$Model, project, maybeKeyPair, false, true);
	});
var author$project$Project$address = function (_n0) {
	var data = _n0.a;
	return data.address;
};
var author$project$Project$Address$string = function (_n0) {
	var str = _n0.a;
	return str;
};
...
var author$project$Project$findByAddr = F2(
	function (projects, addr) {
		var addrList = A2(
			elm$core$List$map,
			function (p) {
				return _Utils_Tuple2(
					author$project$Project$Address$string(
						author$project$Project$address(p)),
					p);
			},
			projects);
		var projectMap = elm$core$Dict$fromList(addrList);
		return A2(elm$core$Dict$get, addr, projectMap);
	});
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Route$Project('1b4atzir794d11ckjtk7xawsqjizgwwabx9bun7qmw5ic7uxr1mj'),
...
var author$project$Main$pageFromUrl = F3(
	function (projects, maybeKeyPair, url) {
		...
		while (true) {
			if (_n0.$ === 'Just') {
				switch (_n0.a.$) {
					...
					case 'Project':
						var addr = _n0.a.a;
						var _n2 = A2(author$project$Project$findByAddr, projects, addr);
						if (_n2.$ === 'Nothing') {
							return author$project$Main$NotFound;
						} else {
							var project = _n2.a;
							return author$project$Main$Project(
								A2(author$project$Page$Project$init, project, maybeKeyPair));
						}
					default:
						break _n0$2;
				}
...
var author$project$Main$init = F3(
	function (encodedFlags, url, navKey) {
		var _n0 = author$project$Main$decodeFlags(encodedFlags);
		var maybeKeyPair = _n0.maybeKeyPair;
		var projects = _n0.projects;
		var page = A3(author$project$Main$pageFromUrl, projects, maybeKeyPair, url);
		return _Utils_Tuple2(
			{maybeKeyPair: maybeKeyPair, navKey: navKey, page: page, projects: projects, topBarModel: author$project$TopBar$init},
...
var author$project$Main$PageProject = function (a) {
	return {$: 'PageProject', a: a};
};
var author$project$Main$TopBarMsg = function (a) {
	return {$: 'TopBarMsg', a: a};
};
var elm$core$Basics$not = _Basics_not;
var author$project$Page$Project$update = F2(
	function (msg, _n0) {
		var project = _n0.a;
		var maybeKeyPair = _n0.b;
		var showOverlay = _n0.c;
		var showGetStarted = _n0.d;
		if (msg.$ === 'CloseGetStarted') {
			return _Utils_Tuple2(
				A4(author$project$Page$Project$Model, project, maybeKeyPair, showOverlay, false),
				elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				A4(author$project$Page$Project$Model, project, maybeKeyPair, !showOverlay, showGetStarted),
				elm$core$Platform$Cmd$none);
		}
	});
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: A3(author$project$Main$pageFromUrl, model.projects, model.maybeKeyPair, url)
						}),
					elm$core$Platform$Cmd$none);
			case 'PageProject':
				var subCmd = msg.a;
				...
				if (_n2.$ === 'Project') {
					var subModel = _n2.a;
					var _n3 = A2(author$project$Page$Project$update, subCmd, subModel);
					var pageModel = _n3.a;
					var pageCmd = _n3.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$Project(pageModel)
							}),
						A2(elm$core$Platform$Cmd$map, author$project$Main$PageProject, pageCmd));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
...
var author$project$Footer$view = A2(
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$px(88)),
	...
	_List_fromArray(
		[
			...
			{
				label: author$project$Atom$Icon$logoCircle(author$project$Style$Color$black),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			...
			{
				label: mdgriffith$elm_ui$Element$text('What is oscoin?'),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				...
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
			{
				label: mdgriffith$elm_ui$Element$text('Maintainers'),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				...
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
			{
				label: mdgriffith$elm_ui$Element$text('Contributors'),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				...
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
			{
				label: mdgriffith$elm_ui$Element$text('Supporters'),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				...
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
			{
				label: mdgriffith$elm_ui$Element$text('Security'),
				url: '/'
			}),
			A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				...
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
			{
				label: mdgriffith$elm_ui$Element$text('Privacy'),
				url: '/'
			})
		]));
...
var author$project$Atom$Icon$notFound = function (color) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M33.3688 34.8269C30.457 33.6208 27.3361 33 24.1844 33C21.0327 33 17.9118 33.6208 15 34.8269'),
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2')
						]),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$x('10.8721'),
							elm$svg$Svg$Attributes$y('18.5361'),
							elm$svg$Svg$Attributes$width('6'),
							elm$svg$Svg$Attributes$height('2'),
							elm$svg$Svg$Attributes$transform('rotate(-10 10.8721 18.5361)'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$x('31.2192'),
							elm$svg$Svg$Attributes$y('17.4943'),
							elm$svg$Svg$Attributes$width('6'),
							elm$svg$Svg$Attributes$height('2'),
							elm$svg$Svg$Attributes$transform('rotate(10 31.2192 17.4943)'),
							elm$svg$Svg$Attributes$fill(
							author$project$Style$Color$toCssString(color))
						]),
					_List_Nil)
	...
	A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[mdgriffith$elm_ui$Element$centerX]),
				author$project$Atom$Icon$notFound(author$project$Style$Color$black)),
				A2(
				mdgriffith$elm_ui$Element$el,
				_Utils_ap(
					_List_Nil,
...
var author$project$Page$Project$CloseGetStarted = {$: 'CloseGetStarted'};
var author$project$Page$Project$ToggleOverlay = {$: 'ToggleOverlay'};
...
var author$project$Atom$Button$style = F5(
	function (bgColor, textColor, hoverColor, attr, children) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
					[
						...
						{bottom: 11, left: 16, right: 16, top: 9}),
...
var author$project$Atom$Button$stylePointer = F5(
	function (bgColor, textColor, hoverColor, attrs, children) {
		return A5(
			author$project$Atom$Button$style,
			bgColor,
			textColor,
			hoverColor,
			A2(elm$core$List$cons, mdgriffith$elm_ui$Element$pointer, attrs),
			children);
	});
...
var author$project$Atom$Button$transparent = F2(
	function (attrs, children) {
		return A5(
			author$project$Atom$Button$stylePointer,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$white, 0),
			author$project$Style$Color$darkGrey,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$almostWhite, 0.5),
			attrs,
			children);
	});
...
var author$project$Atom$Heading$section = F2(
	function (attr, title) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_Utils_ap(
...
var author$project$Atom$Heading$sectionWithInfo = F3(
	function (attr, title, component) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
...
var author$project$Atom$Icon$custom = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$dependency = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$fund = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$maintainer = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$donation = F2(
	function (don, color) {
		switch (don.$) {
			case 'DonationFundSaving':
				return author$project$Atom$Icon$fund(color);
			case 'DonationEqualMaintainer':
				return author$project$Atom$Icon$maintainer(color);
			case 'DonationEqualDependency':
				return author$project$Atom$Icon$dependency(color);
			default:
				return author$project$Atom$Icon$custom(color);
		}
	});
var author$project$Atom$Icon$burn = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$reward = F2(
	function (rew, color) {
		switch (rew.$) {
			case 'RewardBurn':
				return author$project$Atom$Icon$burn(color);
			case 'RewardFundSaving':
				return author$project$Atom$Icon$fund(color);
			case 'RewardEqualMaintainer':
				return author$project$Atom$Icon$maintainer(color);
...
var author$project$Atom$Icon$multiSigner = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$singleSigner = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Atom$Icon$role = F2(
	function (rol, color) {
		if (rol.$ === 'RoleMaintainerSingleSigner') {
			return author$project$Atom$Icon$singleSigner(color);
		} else {
			return author$project$Atom$Icon$multiSigner(color);
		}
	});
...
var author$project$Molecule$Rule$view = F7(
	function (attr, ruleIcon, ruleName, ruleDesc, borderColor, bgColor, textColor) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_Utils_ap(
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$height(
						mdgriffith$elm_ui$Element$px(184))
					]),
				attr),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_Utils_ap(
								...
								author$project$Style$Font$mediumBodyText(textColor)),
							mdgriffith$elm_ui$Element$text(ruleName))
						])),
					A2(
					...
					_Utils_ap(
						...
						author$project$Style$Font$bodyText(textColor)),
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text(ruleDesc)
						]))
				]));
	});
var author$project$Style$Color$purple = A3(mdgriffith$elm_ui$Element$rgb255, 120, 52, 232);
var author$project$Molecule$Rule$active = F3(
	function (ruleIcon, ruleName, ruleDesc) {
		return A7(author$project$Molecule$Rule$view, _List_Nil, ruleIcon, ruleName, ruleDesc, author$project$Style$Color$purple, author$project$Style$Color$white, author$project$Style$Color$purple);
	});
var author$project$Molecule$ContractPreview$viewRule = F4(
	function (title, ruleIcon, ruleName, ruleDesc) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$text(title)),
					A3(author$project$Molecule$Rule$active, ruleIcon, ruleName, ruleDesc)
				]));
	});
...
var author$project$Project$Contract$donationDesc = function (don) {
	switch (don.$) {
		case 'DonationFundSaving':
			return 'Donations to the project go to the project fund. The maintainer can then do with it what they want.';
		case 'DonationEqualMaintainer':
			return 'Donations to the project get distributed equally between each maintainer of the project.';
		case 'DonationEqualDependency':
			return 'Donations to the project get distributed equally between each dependency of the project.';
		default:
			return 'Design a custom distribution of the donations to the project between the project fund, maintainers, contributors and/or dependencies.';
	}
};
var author$project$Project$Contract$donationName = function (don) {
	switch (don.$) {
		case 'DonationFundSaving':
			return 'Save to fund';
		case 'DonationEqualMaintainer':
			return 'Distribute to maintainers';
		case 'DonationEqualDependency':
			return 'Distribute to dependencies';
		default:
...
var author$project$Project$Contract$rewardDesc = function (rew) {
	switch (rew.$) {
		case 'RewardBurn':
			return 'The oscoin reward gets burned, diminishing the supply of OSC and increasing the value of each token.';
		case 'RewardFundSaving':
			return 'The oscoin reward goes to the project fund. The maintainer can then do with it what they want.';
		case 'RewardEqualMaintainer':
			return 'The oscoin reward is distributed equally among maintainers of the project.';
		case 'RewardEqualDependency':
			return 'The oscoin reward is distributed equally among dependencies of the project.';
		default:
			return 'Design a custom distribution of the reward between the project fund, maintainers, contributors, and/or dependencies.';
	}
};
var author$project$Project$Contract$rewardName = function (rew) {
	switch (rew.$) {
		case 'RewardBurn':
			return 'Burn Reward';
		case 'RewardFundSaving':
...
var author$project$Project$Contract$roleDesc = function (rol) {
	if (rol.$ === 'RoleMaintainerSingleSigner') {
		return 'Only one maintainers’ signature is necessary to make changes to the project.';
	} else {
		return 'Multiple maintainer signatures are necessary to make changes.';
	}
};
var author$project$Project$Contract$roleName = function (rol) {
	if (rol.$ === 'RoleMaintainerSingleSigner') {
		return 'Any maintainer can sign';
	} else {
		return 'Multiple maintainers need to sign';
	}
};
var author$project$Molecule$ContractPreview$view = F2(
	function (attr, contract) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
			...
			_List_fromArray(
				[
					A4(
					author$project$Molecule$ContractPreview$viewRule,
					'Network reward distribution',
					author$project$Atom$Icon$reward(
						author$project$Project$Contract$reward(contract)),
					author$project$Project$Contract$rewardName(
						author$project$Project$Contract$reward(contract)),
					author$project$Project$Contract$rewardDesc(
						author$project$Project$Contract$reward(contract))),
					A4(
					author$project$Molecule$ContractPreview$viewRule,
					'Donation distribution',
					author$project$Atom$Icon$donation(
						author$project$Project$Contract$donation(contract)),
					author$project$Project$Contract$donationName(
						author$project$Project$Contract$donation(contract)),
					author$project$Project$Contract$donationDesc(
						author$project$Project$Contract$donation(contract))),
					A4(
					author$project$Molecule$ContractPreview$viewRule,
					'Roles & abilities',
					author$project$Atom$Icon$role(
						author$project$Project$Contract$role(contract)),
					author$project$Project$Contract$roleName(
						author$project$Project$Contract$role(contract)),
					author$project$Project$Contract$roleDesc(
						author$project$Project$Contract$role(contract)))
				]));
	});
var author$project$Page$Project$Contract$view = F2(
	function (contract, isMaintainer) {
		var header = isMaintainer ? A3(
			...
			'Project contract',
			A2(
				author$project$Atom$Button$transparent,
				_List_Nil,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Edit')
					]))) : A2(
			author$project$Atom$Heading$section,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Border$color(author$project$Style$Color$lightGrey),
					mdgriffith$elm_ui$Element$Border$widthEach(
		...
		return A2(
			...
			_List_fromArray(
				[
					header,
					A2(author$project$Molecule$ContractPreview$view, _List_Nil, contract)
				]));
	});
...
var author$project$Atom$Button$custom = F4(
	function (color, textColor, attrs, children) {
		return A5(
			author$project$Atom$Button$stylePointer,
			color,
			textColor,
			A2(author$project$Style$Color$alpha, color, 0.85),
			attrs,
			children);
	});
...
var author$project$Style$Font$smallMediumAllCapsText = function (textColor) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$color(textColor),
			mdgriffith$elm_ui$Element$Font$family(
			...
			mdgriffith$elm_ui$Element$Font$letterSpacing(1.2)
		]);
};
var author$project$Atom$Table$headCenter = F2(
	function (attr, headerText) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_Utils_ap(
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 0, left: 0, right: 0, top: 9})
					]),
				_Utils_ap(
					author$project$Style$Font$smallMediumAllCapsText(author$project$Style$Color$darkGrey),
					attr)),
...
var author$project$Atom$Table$headLeft = F2(
	function (attr, headerText) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_Utils_ap(
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 0, left: 24, right: 0, top: 9})
					]),
				_Utils_ap(
					author$project$Style$Font$smallMediumAllCapsText(author$project$Style$Color$darkGrey),
					attr)),
...
var author$project$Atom$Table$headRight = F2(
	function (attr, headerText) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_Utils_ap(
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 0, left: 0, right: 24, top: 9})
					]),
				_Utils_ap(
					author$project$Style$Font$smallMediumAllCapsText(author$project$Style$Color$darkGrey),
					attr)),
...
var author$project$Atom$Icon$initialCircle = F2(
	function (bgColor, initials) {
		return mdgriffith$elm_ui$Element$html(
			A2(
				elm$svg$Svg$svg,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Style$Color$toCssString(bgColor)),
								elm$svg$Svg$Attributes$stroke(
								author$project$Style$Color$toCssString(author$project$Style$Color$lightGrey)),
						...
						_List_fromArray(
							[
								...
								elm$svg$Svg$Attributes$height('24'),
								elm$svg$Svg$Attributes$fill(
								author$project$Style$Color$toCssString(author$project$Style$Color$white)),
								elm$svg$Svg$Attributes$fontFamily('GT America Medium'),
								elm$svg$Svg$Attributes$fontSize('12'),
								elm$svg$Svg$Attributes$textAnchor('middle')
							]),
						_List_fromArray(
							[
								elm$svg$Svg$text(initials)
							]))
					])));
	});
var author$project$Page$Project$Fund$viewFundsDestination = function (dest) {
	return A2(author$project$Atom$Icon$initialCircle, author$project$Style$Color$purple, dest);
};
var author$project$Page$Project$Fund$viewFundsDestinations = function (exchange) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$paddingEach(
				{bottom: 9, left: 0, right: 0, top: 0}),
				mdgriffith$elm_ui$Element$height(
				mdgriffith$elm_ui$Element$px(64)),
				mdgriffith$elm_ui$Element$spacing(12)
			]),
		A2(elm$core$List$map, author$project$Page$Project$Fund$viewFundsDestination, exchange.destinations));
};
var author$project$Atom$Icon$transfer = F2(
	function (trans, color) {
		return author$project$Atom$Icon$burn(color);
	});
var author$project$Project$Funds$transferName = function (trans) {
	return 'Outgoing transfer';
};
var author$project$Page$Project$Fund$viewFundsRule = function (exchange) {
	var _n0 = function () {
		var _n1 = exchange.rule;
		switch (_n1.$) {
			case 'RewardRule':
				var reward = _n1.a;
				return _Utils_Tuple2(
					A2(author$project$Atom$Icon$reward, reward, author$project$Style$Color$purple),
					author$project$Project$Contract$rewardName(reward));
			case 'DonationRule':
				var donation = _n1.a;
				return _Utils_Tuple2(
					A2(author$project$Atom$Icon$donation, donation, author$project$Style$Color$purple),
					author$project$Project$Contract$donationName(donation));
			default:
				var transfer = _n1.a;
				return _Utils_Tuple2(
					A2(author$project$Atom$Icon$transfer, transfer, author$project$Style$Color$purple),
					author$project$Project$Funds$transferName(transfer));
		}
	}();
	var icon = _n0.a;
	var name = _n0.b;
	return A2(
		...
		_Utils_ap(
			...
			author$project$Style$Font$bodyText(author$project$Style$Color$purple)),
		_List_fromArray(
			[
				icon,
				A2(
...
var author$project$Project$Funds$exchanges = function (_n0) {
	var es = _n0.b;
	return es;
};
...
var author$project$Style$Font$bodyTextMono = function (textColor) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$color(textColor),
			mdgriffith$elm_ui$Element$Font$family(
...
var author$project$Page$Project$Fund$viewTable = F2(
	function (funds, isMaintainer) {
		var viewMoreBtn = (elm$core$List$length(
			author$project$Project$Funds$exchanges(funds)) > 0) ? A4(
			author$project$Atom$Button$custom,
			author$project$Style$Color$almostWhite,
			author$project$Style$Color$darkGrey,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
		...
		var content = (isMaintainer && (!elm$core$List$length(
			author$project$Project$Funds$exchanges(funds)))) ? A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			...
			A2(
				...
				_Utils_ap(
					...
					author$project$Style$Font$bodyText(author$project$Style$Color$grey)),
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Checkpoint your project to start receiving network rewards.')
			...
			A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('No current funds')
					]))) : mdgriffith$elm_ui$Element$none);
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
				...
				[
					...
					_List_Nil,
					{
						columns: _List_fromArray(
							[
								{
								header: A2(author$project$Atom$Table$headLeft, _List_Nil, 'SOURCE'),
								view: function (exchange) {
									return A2(
										mdgriffith$elm_ui$Element$el,
										_Utils_ap(
											_List_fromArray(
												[
													mdgriffith$elm_ui$Element$paddingEach(
													{bottom: 0, left: 24, right: 0, top: 20}),
													mdgriffith$elm_ui$Element$height(
													mdgriffith$elm_ui$Element$px(64))
												]),
											author$project$Style$Font$mediumBodyText(author$project$Style$Color$darkGrey)),
										mdgriffith$elm_ui$Element$text(exchange.source));
								},
								width: mdgriffith$elm_ui$Element$px(240)
							},
								{
								header: A2(author$project$Atom$Table$headCenter, _List_Nil, 'DATE'),
								view: function (exchange) {
									return A2(
										mdgriffith$elm_ui$Element$el,
										_Utils_ap(
											...
											author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
										mdgriffith$elm_ui$Element$text(exchange.date));
								},
								width: mdgriffith$elm_ui$Element$px(134)
							},
								{
								header: A2(author$project$Atom$Table$headCenter, _List_Nil, 'RULE'),
								view: author$project$Page$Project$Fund$viewFundsRule,
								width: mdgriffith$elm_ui$Element$px(250)
							},
								{
								header: A2(author$project$Atom$Table$headCenter, _List_Nil, 'DESTINATION'),
								view: author$project$Page$Project$Fund$viewFundsDestinations,
								width: mdgriffith$elm_ui$Element$px(207)
							},
								{
								header: A2(
									author$project$Atom$Table$headCenter,
									_List_fromArray(
								...
								view: function (exchange) {
									return A2(
										...
										_Utils_ap(
											...
											author$project$Style$Font$bodyTextMono(author$project$Style$Color$darkGrey)),
										mdgriffith$elm_ui$Element$text(
											elm$core$String$fromInt(exchange.incoming)));
								},
								width: mdgriffith$elm_ui$Element$px(66)
							},
								{
								header: A2(
									author$project$Atom$Table$headCenter,
								...
								view: function (exchange) {
									return A2(
										...
										_Utils_ap(
											...
											author$project$Style$Font$bodyTextMono(author$project$Style$Color$darkGrey)),
										mdgriffith$elm_ui$Element$text(
											elm$core$String$fromInt(exchange.outgoing)));
								},
								width: mdgriffith$elm_ui$Element$px(66)
							},
								{
								header: A2(
									author$project$Atom$Table$headRight,
									_List_fromArray(
										[mdgriffith$elm_ui$Element$Font$alignRight]),
									'FUND'),
								view: function (exchange) {
										...
										_Utils_ap(
											_List_fromArray(
												[
													...
													mdgriffith$elm_ui$Element$px(64)),
													mdgriffith$elm_ui$Element$paddingEach(
													{bottom: 0, left: 0, right: 24, top: 20})
												]),
											author$project$Style$Font$boldBodyTextMono(author$project$Style$Color$darkGrey)),
										mdgriffith$elm_ui$Element$text(
											elm$core$String$fromInt(exchange.incoming - exchange.outgoing)));
								},
								width: mdgriffith$elm_ui$Element$px(111)
							}
							]),
						data: author$project$Project$Funds$exchanges(funds)
					}),
					content,
					viewMoreBtn
				]));
	});
var author$project$Project$Funds$coins = function (_n0) {
	var osc = _n0.a;
	return osc;
};
var author$project$Project$Funds$coinsString = function (_n0) {
	var cs = _n0.a;
	return elm$core$String$fromInt(cs);
};
var author$project$Project$Funds$multiply = F2(
	function (_n0, q) {
		var cs = _n0.a;
		return cs * q;
	});
var author$project$Page$Project$Fund$view = F2(
	function (funds, isMaintainer) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				...
				[
					...
					A2(
						...
						_List_fromArray(
							[
								A2(
								author$project$Atom$Currency$large,
								author$project$Project$Funds$coinsString(
									author$project$Project$Funds$coins(funds)),
								author$project$Style$Color$purple),
								A2(
								mdgriffith$elm_ui$Element$el,
								_Utils_ap(
									_List_fromArray(
									...
									author$project$Style$Font$bodyTextMono(author$project$Style$Color$grey)),
								mdgriffith$elm_ui$Element$text(
									'($' + (elm$core$String$fromFloat(
										A2(
											author$project$Project$Funds$multiply,
											author$project$Project$Funds$coins(funds),
											15.14)) + ')')))
							]))),
					A2(author$project$Page$Project$Fund$viewTable, funds, isMaintainer)
				]));
	});
...
var author$project$Page$Project$GetStarted$viewCheckpoint = function (address) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					_List_Nil,
					author$project$Style$Font$mediumBodyText(author$project$Style$Color$black)),
				mdgriffith$elm_ui$Element$text('You’ve done this before')),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				A2(
					elm$core$List$cons,
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Open your project in the terminal and run the checkpoint command. It will automatically detect support package manager manifest files')
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$text('$ osc checkpoint ' + address)),
						A2(
						author$project$Atom$Button$transparent,
						_List_fromArray(
							[mdgriffith$elm_ui$Element$alignRight]),
...
var author$project$Atom$Icon$cross = function (color) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M8 8L16 16'),
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2'),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M8 16L16 8'),
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2'),
							elm$svg$Svg$Attributes$strokeLinecap('round')
...
var author$project$Page$Project$GetStarted$viewExplanation = function (closeMsg) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_Nil,
							author$project$Style$Font$mediumHeader(author$project$Style$Color$black)),
						mdgriffith$elm_ui$Element$text('Getting started')),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						author$project$Atom$Icon$cross(author$project$Style$Color$darkGrey))
					])),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				_Utils_ap(
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$width(
							A2(mdgriffith$elm_ui$Element$maximum, 820, mdgriffith$elm_ui$Element$fill))
						]),
					author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey)),
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('First, you have to checkpoint your project to share your dependencies and contributors with the oscoin network. This will allow the network to calculate the osrank and distribute the network reward to your project accordingly.')
					]))
			]));
};
var author$project$Page$Project$GetStarted$viewSetup = A2(
	mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$padding(24),
	...
	_List_fromArray(
		[
			...
			_Utils_ap(
				_List_Nil,
				author$project$Style$Font$mediumBodyText(author$project$Style$Color$black)),
			mdgriffith$elm_ui$Element$text('First time user')),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			A2(
				elm$core$List$cons,
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('In order to run any oscoin command the osc tool must be present, which can be acquired through brew if on macos')
				])),
			A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						_List_Nil,
						author$project$Style$Font$smallTextMono(author$project$Style$Color$black)),
					mdgriffith$elm_ui$Element$text('$ brow install oscoin-cli')),
					A2(
					author$project$Atom$Button$transparent,
					_List_fromArray(
						[mdgriffith$elm_ui$Element$alignRight]),
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Once installed, run this command to get started')
				])),
			A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						_List_Nil,
						author$project$Style$Font$smallTextMono(author$project$Style$Color$black)),
					mdgriffith$elm_ui$Element$text('$ osc setup')),
					A2(
					author$project$Atom$Button$transparent,
					_List_fromArray(
						[mdgriffith$elm_ui$Element$alignRight]),
...
var author$project$Page$Project$GetStarted$view = F2(
	function (project, closeMsg) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					author$project$Page$Project$GetStarted$viewExplanation(closeMsg),
					author$project$Page$Project$GetStarted$viewSetup,
					author$project$Page$Project$GetStarted$viewCheckpoint(
					author$project$Project$Address$string(
						author$project$Project$address(project)))
				]));
	});
var author$project$Atom$Heading$sectionWithCount = F3(
	function (attr, title, count) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Background$color(author$project$Style$Color$purple),
								mdgriffith$elm_ui$Element$paddingEach(
								{bottom: 5, left: 8, right: 8, top: 4}),
								mdgriffith$elm_ui$Element$Border$rounded(2)
							]),
						author$project$Style$Font$boldBodyTextMono(author$project$Style$Color$white)),
					mdgriffith$elm_ui$Element$text(
						elm$core$String$fromInt(count)))
				]));
	});
var author$project$Project$Graph$edgeName = function (_n0) {
	var n = _n0.a;
	return n;
};
var author$project$Page$Project$Graph$viewProjectName = function (project) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 0, left: 24, right: 0, top: 11}),
					mdgriffith$elm_ui$Element$height(
					mdgriffith$elm_ui$Element$px(40))
				]),
			author$project$Style$Font$mediumBodyText(author$project$Style$Color$darkGrey)),
		mdgriffith$elm_ui$Element$text(
			author$project$Project$Graph$edgeName(project)));
};
var author$project$Project$Graph$edgeRank = function (_n0) {
	var r = _n0.c;
	return r;
};
var author$project$Project$Graph$rankString = function (_n0) {
	var r = _n0.a;
	return elm$core$String$fromFloat(r);
};
var author$project$Page$Project$Graph$viewProjectRank = function (project) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 0, left: 0, right: 24, top: 11}),
					mdgriffith$elm_ui$Element$height(
					mdgriffith$elm_ui$Element$px(40)),
					mdgriffith$elm_ui$Element$Font$alignRight
				]),
			author$project$Style$Font$boldBodyTextMono(author$project$Style$Color$darkGrey)),
		mdgriffith$elm_ui$Element$text(
			author$project$Project$Graph$rankString(
				author$project$Project$Graph$edgeRank(project))));
};
...
var author$project$Page$Project$Graph$viewProjects = F3(
	function (edges, title, isMaintainer) {
		var viewMoreBtn = (elm$core$List$length(edges) > 5) ? A4(
			author$project$Atom$Button$custom,
			author$project$Style$Color$almostWhite,
			author$project$Style$Color$darkGrey,
			_List_fromArray(
		...
		var ifEmpty = (isMaintainer && (!elm$core$List$length(edges))) ? A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			...
			A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('Checkpoint your project to add dependents and dependencies.')
					]))) : ((!elm$core$List$length(edges)) ? A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			...
			A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('This list is empty')
					]))) : mdgriffith$elm_ui$Element$none);
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A3(
					author$project$Atom$Heading$sectionWithCount,
					_List_Nil,
					title,
					...
					_List_Nil,
					{
						columns: _List_fromArray(
							[
								{
								header: A2(author$project$Atom$Table$headLeft, _List_Nil, 'PROJECT NAME'),
								view: author$project$Page$Project$Graph$viewProjectName,
								width: mdgriffith$elm_ui$Element$px(442)
							},
								{
								header: A2(author$project$Atom$Table$headRight, _List_Nil, 'OSRANK'),
								view: author$project$Page$Project$Graph$viewProjectRank,
								width: mdgriffith$elm_ui$Element$px(83)
							}
							]),
						data: A2(elm$core$List$take, 5, edges)
					}),
					ifEmpty,
					viewMoreBtn
				]));
	});
var author$project$Project$Graph$isOutgoing = function (_n0) {
	var d = _n0.b;
	if (d.$ === 'Incoming') {
		return false;
	} else {
...
var author$project$Project$Graph$dependencies = function (_n0) {
	var es = _n0.c;
	return A2(elm$core$List$filter, author$project$Project$Graph$isOutgoing, es);
};
var author$project$Project$Graph$isIncoming = function (_n0) {
	var d = _n0.b;
	if (d.$ === 'Incoming') {
		return true;
	} else {
...
var author$project$Project$Graph$dependents = function (_n0) {
	var es = _n0.c;
	return A2(elm$core$List$filter, author$project$Project$Graph$isIncoming, es);
};
var author$project$Page$Project$Graph$view = F2(
	function (graph, isMaintainer) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A3(
					author$project$Page$Project$Graph$viewProjects,
					author$project$Project$Graph$dependents(graph),
					'Dependents',
					isMaintainer),
					A3(
					author$project$Page$Project$Graph$viewProjects,
					author$project$Project$Graph$dependencies(graph),
					'Dependencies',
					isMaintainer)
				]));
	});
...
var author$project$Atom$Icon$imageFallback = mdgriffith$elm_ui$Element$html(
	A2(
		elm$svg$Svg$svg,
		_List_fromArray(
			[
				elm$svg$Svg$Attributes$width('72'),
				elm$svg$Svg$Attributes$height('72'),
				elm$svg$Svg$Attributes$viewBox('0 0 72 72'),
				elm$svg$Svg$Attributes$fill('none')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$d('M72 0H0V72H72V0Z'),
						elm$svg$Svg$Attributes$fill('url(#paint0_radial)')
					]),
				_List_Nil),
				A2(
				elm$svg$Svg$defs,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$svg$Svg$Attributes$id('paint0_radial'),
								...
								elm$svg$Svg$Attributes$gradientTransform('translate(36 36) rotate(90) scale(111)')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$stopColor('#E074CB')
									]),
								_List_Nil),
								A2(
								elm$svg$Svg$stop,
								_List_fromArray(
									[
										...
										elm$svg$Svg$Attributes$stopColor('#6E41E0')
									]),
								_List_Nil)
							]))
					]))
			])));
var author$project$Project$Meta$imageUrl = function (meta) {
	return meta.imageUrl;
};
var author$project$Project$Meta$name = function (meta) {
	return meta.name;
};
...
var author$project$Molecule$ProjectMeta$viewLogo = function (meta) {
	var image = (author$project$Project$Meta$imageUrl(meta) === '') ? author$project$Atom$Icon$imageFallback : A2(
		...
		{
			description: author$project$Project$Meta$name(meta),
			src: author$project$Project$Meta$imageUrl(meta)
		});
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(author$project$Style$Color$lightGrey),
				mdgriffith$elm_ui$Element$width(
				mdgriffith$elm_ui$Element$px(72)),
				mdgriffith$elm_ui$Element$height(
				mdgriffith$elm_ui$Element$px(72)),
...
var author$project$Atom$Icon$copy = mdgriffith$elm_ui$Element$html(
	A2(
		elm$svg$Svg$svg,
		_List_fromArray(
			[
...
var author$project$Style$Font$boldSmallTextMono = function (textColor) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$color(textColor),
			mdgriffith$elm_ui$Element$Font$family(
...
var author$project$Molecule$ProjectMeta$viewMeta = function (project) {
	var meta = author$project$Project$meta(project);
	var addr = A3(
		elm$core$String$slice,
		0,
		23,
		author$project$Project$prettyAddress(project)) + '...';
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$spacing(8),
				mdgriffith$elm_ui$Element$width(
				A2(mdgriffith$elm_ui$Element$maximum, 420, mdgriffith$elm_ui$Element$fill)),
				mdgriffith$elm_ui$Element$alignTop
			]),
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text(
					author$project$Project$Meta$name(meta))),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$pointer]),
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							author$project$Style$Font$boldSmallTextMono(author$project$Style$Color$grey)),
						mdgriffith$elm_ui$Element$text(addr)),
						author$project$Atom$Icon$copy
					])),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				_Utils_ap(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(
						author$project$Project$Meta$description(meta))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											mdgriffith$elm_ui$Element$Font$color(author$project$Style$Color$blue)
										]))
								]),
							author$project$Style$Font$mediumBodyText(author$project$Style$Color$darkGrey)),
						{
							label: mdgriffith$elm_ui$Element$text(
								author$project$Project$Meta$codeHostUrl(meta)),
							url: author$project$Project$Meta$codeHostUrl(meta)
						}),
						A2(
						mdgriffith$elm_ui$Element$link,
						_Utils_ap(
						...
						{
							label: mdgriffith$elm_ui$Element$text(
								author$project$Project$Meta$websiteUrl(meta)),
							url: author$project$Project$Meta$websiteUrl(meta)
						})
					]))
			]));
};
var author$project$Molecule$ProjectMeta$view = function (project) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Molecule$ProjectMeta$viewLogo(
				author$project$Project$meta(project)),
				author$project$Molecule$ProjectMeta$viewMeta(project)
			]));
};
var author$project$Atom$Button$primary = F2(
	function (attrs, children) {
		return A5(
			author$project$Atom$Button$stylePointer,
			author$project$Style$Color$purple,
			author$project$Style$Color$white,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$purple, 0.85),
			attrs,
			children);
	});
...
var author$project$Atom$Button$secondaryAccent = F2(
	function (attrs, children) {
		return A5(
			...
			author$project$Style$Color$white,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$green, 0.85),
			attrs,
			children);
	});
var elm$svg$Svg$Attributes$strokeLinejoin = _VirtualDom_attribute('stroke-linejoin');
var author$project$Atom$Icon$selectDown = function (color) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M8 10L12 14L16 10'),
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2'),
							elm$svg$Svg$Attributes$strokeLinecap('round'),
...
var author$project$Atom$Icon$selectUp = function (color) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$d('M16 14L12 10L8 14'),
							elm$svg$Svg$Attributes$stroke(
							author$project$Style$Color$toCssString(color)),
							elm$svg$Svg$Attributes$strokeWidth('2'),
							elm$svg$Svg$Attributes$strokeLinecap('round'),
...
var author$project$Page$Project$Actions$listAttrs = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$paddingEach(
...
var author$project$Page$Project$Actions$viewCheckpointOverlay = function (project) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				{
					blur: 16,
					color: A2(author$project$Style$Color$alpha, author$project$Style$Color$black, 8.0e-2),
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$el,
				author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey),
				mdgriffith$elm_ui$Element$text('Run this command in the project folder')),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							author$project$Style$Font$smallTextMono(author$project$Style$Color$black)),
						mdgriffith$elm_ui$Element$text(
							'$ osc checkpoint ' + author$project$Project$Address$string(
								author$project$Project$address(project)))),
						A2(
						author$project$Atom$Button$transparent,
						_List_fromArray(
...
var author$project$Page$Project$Actions$viewMaintainer = F3(
	function (showOverlay, toggleMsg, project) {
		var _n0 = showOverlay ? _Utils_Tuple2(
			author$project$Atom$Icon$selectUp,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$below(
					author$project$Page$Project$Actions$viewCheckpointOverlay(project))
				])) : _Utils_Tuple2(author$project$Atom$Icon$selectDown, _List_Nil);
		var icon = _n0.a;
		var overlayAttrs = _n0.b;
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(author$project$Page$Project$Actions$listAttrs, overlayAttrs),
			_List_fromArray(
				[
					A2(
					author$project$Atom$Button$primary,
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Events$onClick(toggleMsg)
						]),
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Checkpoint your project'),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							icon(author$project$Style$Color$white))
						])),
					A2(
					author$project$Atom$Button$secondaryAccent,
					_List_Nil,
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Share your project')
						]))
				]));
	});
var author$project$Atom$Button$secondary = F2(
	function (attrs, children) {
		return A5(
			author$project$Atom$Button$stylePointer,
			author$project$Style$Color$lightGrey,
			author$project$Style$Color$darkGrey,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$lightGrey, 0.85),
			attrs,
			children);
	});
var author$project$Page$Project$Actions$viewViewer = A2(
	mdgriffith$elm_ui$Element$row,
	author$project$Page$Project$Actions$listAttrs,
	_List_fromArray(
		[
			A2(
			author$project$Atom$Button$primary,
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Donate')
				])),
			A2(
			author$project$Atom$Button$secondary,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Follow')
				])),
			A2(
			author$project$Atom$Button$secondaryAccent,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Support')
				]))
		]));
var author$project$Page$Project$Actions$view = F4(
	function (isMaintainer, showOverlay, toggleMsg, project) {
		return isMaintainer ? A3(author$project$Page$Project$Actions$viewMaintainer, showOverlay, toggleMsg, project) : author$project$Page$Project$Actions$viewViewer;
	});
...
var author$project$Page$Project$Header$statsColumn = F3(
	function (stat, unit, info) {
		return A2(
			mdgriffith$elm_ui$Element$textColumn,
			_List_fromArray(
				[
					A2(mdgriffith$elm_ui$Element$paddingXY, 25, 13),
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						author$project$Style$Font$smallTextMono(author$project$Style$Color$grey)),
					_List_fromArray(
						[
...
var author$project$Project$Graph$percentile = function (_n0) {
	var p = _n0.b;
	return p;
};
var author$project$Project$Graph$percentileString = function (_n0) {
	var p = _n0.a;
	return elm$core$String$fromInt(p);
};
var author$project$Project$Graph$rank = function (_n0) {
	var r = _n0.a;
	return r;
};
var author$project$Page$Project$Header$viewStats = function (graph) {
	var percentile = author$project$Project$Graph$percentileString(
		author$project$Project$Graph$percentile(graph));
	var osrank = author$project$Project$Graph$rankString(
		author$project$Project$Graph$rank(graph));
	var immediate = elm$core$String$fromInt(
		elm$core$List$length(
			author$project$Project$Graph$dependents(graph)));
	var dependents = elm$core$String$fromInt(
		elm$core$List$length(
			author$project$Project$Graph$dependents(graph)));
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$alignTop,
				mdgriffith$elm_ui$Element$height(
				A2(mdgriffith$elm_ui$Element$maximum, 112, mdgriffith$elm_ui$Element$fill)),
				mdgriffith$elm_ui$Element$width(
				mdgriffith$elm_ui$Element$px(364)),
				mdgriffith$elm_ui$Element$Background$color(author$project$Style$Color$white)
			]),
		_List_fromArray(
			[
				A3(author$project$Page$Project$Header$statsColumn, dependents, 'dependents', immediate + ' immediate'),
				A3(author$project$Page$Project$Header$statsColumn, osrank, 'osrank', percentile + 'th percentile')
			]));
};
var author$project$Project$graph = function (_n0) {
	var data = _n0.a;
	return data.graph;
};
var author$project$Page$Project$Header$view = F4(
	function (project, isMaintainer, showOverlay, toggleMsg) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Element$paddingXY, 0, 44),
						mdgriffith$elm_ui$Element$width(
						mdgriffith$elm_ui$Element$px(1074)),
						mdgriffith$elm_ui$Element$centerX
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Molecule$ProjectMeta$view(project),
								author$project$Page$Project$Header$viewStats(
								author$project$Project$graph(project))
							])),
						A4(author$project$Page$Project$Actions$view, isMaintainer, showOverlay, toggleMsg, project)
					])));
	});
var author$project$Atom$Icon$largeLogoCircle = function (bgColor) {
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
			_List_fromArray(
...
var author$project$Page$Project$People$viewAvatar = function (imgUrl) {
	return (imgUrl === '') ? A2(
		mdgriffith$elm_ui$Element$el,
		_List_Nil,
		author$project$Atom$Icon$largeLogoCircle(author$project$Style$Color$lightGrey)) : A2(
		mdgriffith$elm_ui$Element$image,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$height(
		...
		{description: 'avatar', src: imgUrl});
};
var author$project$Person$imageUrl = function (_n0) {
	var url = _n0.c;
	return url;
};
var author$project$Person$name = function (_n0) {
	var n = _n0.b;
	return n;
};
var author$project$Page$Project$People$viewTopPeopleSingle = function (person) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Page$Project$People$viewAvatar(
				author$project$Person$imageUrl(person)),
				A2(
				mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						author$project$Style$Font$mediumBodyText(author$project$Style$Color$black),
						mdgriffith$elm_ui$Element$text(
							author$project$Person$name(person))),
						A2(
						mdgriffith$elm_ui$Element$el,
						author$project$Style$Font$bodyText(author$project$Style$Color$darkGrey),
						mdgriffith$elm_ui$Element$text('Core maintainer'))
					]))
			]));
};
...
var author$project$Page$Project$People$viewContributors = F3(
	function (title, people, isMaintainer) {
		var viewMoreBtn = (elm$core$List$length(people) < 5) ? mdgriffith$elm_ui$Element$none : A2(
			author$project$Atom$Button$transparent,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
		...
		var emptyStateCopy = isMaintainer ? 'By checkpointing your project we’ll be able to determine who your contributors are.' : 'No contributors to this project';
		var content = (elm$core$List$length(people) > 0) ? A2(
			mdgriffith$elm_ui$Element$wrappedRow,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 0, left: 24, right: 24, top: 12}),
					mdgriffith$elm_ui$Element$width(
					mdgriffith$elm_ui$Element$fillPortion(1)),
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill)
				]),
			A2(
				elm$core$List$map,
				author$project$Page$Project$People$viewTopPeopleSingle,
				A2(elm$core$List$take, 4, people))) : A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			...
			A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(emptyStateCopy)
					])));
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					title,
					elm$core$List$length(people)),
					content,
					viewMoreBtn
				]));
	});
var author$project$Atom$Heading$sectionWithCountInfo = F4(
	function (attr, title, count, component) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_Utils_ap(
				_List_fromArray(
...
var author$project$Page$Project$People$viewMaintainers = F3(
	function (title, people, isMaintainer) {
		var viewMoreBtn = (elm$core$List$length(people) < 5) ? A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$height(
		...
		var heading = isMaintainer ? A4(
			author$project$Atom$Heading$sectionWithCountInfo,
			_List_Nil,
			title,
			elm$core$List$length(people),
			A2(
			...
			_List_fromArray(
				[
					...
					A2(
						elm$core$List$map,
						author$project$Page$Project$People$viewTopPeopleSingle,
						A2(elm$core$List$take, 4, people))),
					viewMoreBtn
				]));
	});
var author$project$Page$Project$People$view = F3(
	function (maintainers, contributors, isMaintainer) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A3(author$project$Page$Project$People$viewMaintainers, 'Maintainers', maintainers, isMaintainer),
					A3(author$project$Page$Project$People$viewContributors, 'Contributors', contributors, isMaintainer)
				]));
	});
var author$project$Project$checkpoints = function (_n0) {
	var data = _n0.a;
...
var author$project$Project$contributors = function (_n0) {
	var data = _n0.a;
	return data.contributors;
};
var author$project$Project$funds = function (_n0) {
	var data = _n0.a;
	return data.funds;
};
var author$project$KeyPair$id = function (_n0) {
	var i = _n0.a;
	return i;
};
var author$project$KeyPair$pubKey = function (_n0) {
	var pk = _n0.b;
	return pk;
};
var author$project$KeyPair$equal = F2(
	function (a, b) {
		return _Utils_eq(
			author$project$KeyPair$id(a),
			author$project$KeyPair$id(b)) && _Utils_eq(
			author$project$KeyPair$pubKey(a),
			author$project$KeyPair$pubKey(b));
	});
var author$project$Person$keyPair = function (_n0) {
	var kp = _n0.a;
	return kp;
};
var author$project$Project$maintainers = function (_n0) {
	var data = _n0.a;
	return data.maintainers;
};
var author$project$Project$isMaintainer = F2(
	function (keyPair, project) {
		return A2(
			elm$core$List$any,
			author$project$KeyPair$equal(keyPair),
			A2(
				elm$core$List$map,
				author$project$Person$keyPair,
				author$project$Project$maintainers(project)));
	});
var author$project$Page$Project$view = function (_n0) {
	var project = _n0.a;
	var maybeKeyPair = _n0.b;
	var showOverlay = _n0.c;
	var showGetStarted = _n0.d;
	var isMaintainer = function () {
		if (maybeKeyPair.$ === 'Just') {
			var keyPair = maybeKeyPair.a;
			return A2(author$project$Project$isMaintainer, keyPair, project);
		} else {
			return false;
		}
	}();
	var viewCheckpointInfo = (isMaintainer && (showGetStarted && elm$core$List$isEmpty(
		author$project$Project$checkpoints(project)))) ? A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$paddingEach(
		...
		A2(author$project$Page$Project$GetStarted$view, project, author$project$Page$Project$CloseGetStarted)) : mdgriffith$elm_ui$Element$none;
	return _Utils_Tuple2(
		'project',
		A2(
			mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					A4(author$project$Page$Project$Header$view, project, isMaintainer, showOverlay, author$project$Page$Project$ToggleOverlay),
					A2(
					mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							author$project$Project$maintainers(project),
							author$project$Project$contributors(project),
							isMaintainer),
							A2(
							author$project$Page$Project$Fund$view,
							author$project$Project$funds(project),
							isMaintainer),
							A2(
							author$project$Page$Project$Graph$view,
							author$project$Project$graph(project),
							isMaintainer)
						]))
				])));
...
var author$project$Main$viewPage = function (page) {
	switch (page.$) {
		...
		default:
			...
			var _n1 = author$project$Page$Project$view(pageModel);
			var pageTitle = _n1.a;
			var pageView = _n1.b;
			return _Utils_Tuple2(
				pageTitle,
				A2(mdgriffith$elm_ui$Element$map, author$project$Main$PageProject, pageView));
	}
};
...
var author$project$Atom$Button$accent = F2(
	function (attrs, children) {
		return A5(
			...
			author$project$Style$Color$white,
			A2(author$project$Style$Color$alpha, author$project$Style$Color$pink, 0.85),
			attrs,
			children);
	});
...
var author$project$TopBar$view = function (searchTerm) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				{
					label: A2(
						author$project$Atom$Button$accent,
						_List_Nil,
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('Register a project')
							])),
					url: '#'
				})
			]));
